...
export { createMemoryClientFromConfig, type MemoryClient, type ContentAnalysisRow } from './client.js';
 ...
 * enrollments, demo_log — §3; content_analysis — X1). Requires Supabase env
 * vars — there is no JSON fallback for memory tables, only for agent_logs.
 */
